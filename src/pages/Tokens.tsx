...
const ColorSwatch = ({ name, value, textColor = 'rgba(255,250,245,0.7)' }: ColorSwatchProps) => (
  <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 12 }}>
    <div
      style={{
        ...
        boxShadow:
          value.includes('255,180,120') || value.includes('255,200,150')
...
const TextSample = ({ label, style }: TextSampleProps) => (
  <div style={{ marginBottom: 16 }}>
    ...
    <p style={{ margin: '6px 0 0 0', ...style }}>The quick brown fox jumps over the lazy dog</p>
  </div>
)
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 64 }}>
          <PageHeader subtitle="Design Tokens" />
        </div>
        {/* Colors - Background */}
        ...
        <Section title="Typography">
          ...
          />
          <TextSample label="Body (13px)" style={{ color: 'rgba(255,250,245,0.7)', fontSize: 13 }} />
          <TextSample
            label="Caption (12px)"
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                <div
                  style={{ width: 8, height: 8, borderRadius: '50%', background: 'rgba(255,255,255,0.2)' }}
                />
                <span
                  style={{
                    color: 'rgba(255,250,245,0.3)',
              ...
              <p style={{ color: 'rgba(255,250,245,0.7)', fontSize: 14, margin: 0 }}>
                Module Name
              </p>
              <p style={{ color: 'rgba(255,250,245,0.4)', fontSize: 12, margin: '6px 0 0 0' }}>
                Description text
              </p>
            </div>
            ...
            <div
              style={{
                ...
                borderRadius: 14,
                background:
                  'linear-gradient(145deg, rgba(255,200,150,0.12) 0%, rgba(255,180,120,0.06) 100%)',
            ...
            >
              ...
              <p style={{ color: 'rgba(255,250,245,0.5)', fontSize: 12, margin: '6px 0 0 0' }}>
                Description text
              </p>
            </div>
          </div>
                  ...
                  style={{
                    ...
                    background:
                      activeButton === i
                        ...
                        : 'transparent',
                    color:
                      activeButton === i ? 'rgba(255,220,180,0.95)' : 'rgba(255,250,245,0.35)',
                    fontSize: 13,
